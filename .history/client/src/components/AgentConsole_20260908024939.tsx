...
// answer_delta / done 属于"打字机流控"事件，在 handleSend 里特判，不经过这里
        ...
        timerRef.current = setInterval(() => {
            ...
            setMessages((prev) => {
                ...
                if (last?.kind === 'answer_stream') {
                    return [...prev.slice(0, -1), { kind: 'answer_stream', text: last.text + piece }];
                }
                return [...prev, { kind: 'answer_stream', text: piece }];
            });
        }, 30);
    }
