import { ApiError, handleUnauthorized, request } from '@/api/http';
...
// 所以这里手动对齐同一套策略：401 统一收口 + 错误文案优先取后端 error
...
export async function runAgentStream(
    ...
    const res = await fetch('/api/agent/run', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },   // TODO 第5件：加上 Authorization
