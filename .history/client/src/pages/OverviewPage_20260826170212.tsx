...
function OverviewPage() {
    return (
        <div style={{ height: '100%', maxWidth: 1000, margin: '0 auto', display: 'flex', gap: 16 }}>
            {/* 左板块 2/3：选择栏在顶部，业务总览 / 订单列表 二选一 */}
            <div className="overview-tabs" style={{ flex: 2, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
                <Tabs
